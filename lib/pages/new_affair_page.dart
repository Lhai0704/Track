                  ...
                  children: [
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: new Border.all(
                                    color: Color.fromRGBO(22, 87, 96, 1),
                                    width: 2.0),
                                boxShadow: [
                                  BoxShadow(
                                    color: Colors.black,
                          ...
                          Row(
                            ...
                            children: [
                              MaterialButton(
                                ...
                                child: Text("完成"),
                                onPressed: () {
                                  Affair affair = Affair(id: null, icon: widget.icon, color: widget.color, name: name, startTime: startTime, endTime: endTime, category: _selected, remark: remark, checked: model.toInt(_switchSelected));
                    ...
                    Stack(
                      children: [
                        ...
                        NewAffairAppBar(Colors.black12),
                      ],
                    )
                  ],
                )),
